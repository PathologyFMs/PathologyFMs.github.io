const modelData = [
  {
    ...
    models: [
      ...
      { name: "H-optimus-0", year: 2025, data: "500K WSIs", idea: "SSL Pretraining, FM Distillation", github: "https://github.com/bioptimus/releases/tree/main/models/h-optimus/v0", hf: "https://huggingface.co/bioptimus/H-optimus-0", paper: "https://arxiv.org/abs/2501.16239v1" },
  ...
  },
  {
    ...
    models: [
      ...
      { name: "SEAL", year: 2026, data: "---", idea: "---", github: "", hf: "", paper: "" },
      { name: "KRONOS2", year: 2026, data: "---", idea: "---", github: "", hf: "", paper: "" },
  ...
  },
  {
    ...
    models: [
      { name: "GPFM", year: 2025, data: "190M tiles, 96K WSIs", idea: "Multi-teacher distillation", github: "https://github.com/birkhoffkiki/GPFM/", hf: "", paper: "https://arxiv.org/abs/2407.18449" },
      { name: "COBRA", year: 2025, data: "3048 WSIs", idea: "Multi-FM representation integration", github: "https://github.com/KatherLab/COBRA", hf: "https://huggingface.co/KatherLab/COBRA", paper: "https://arxiv.org/abs/2411.13623" },
      { name: "ELF", year: 2025, data: "53K WSIs (20 anatomical sites)", idea: "Ensemble learning", github: "https://github.com/lilab-stanford/ELF", hf: "", paper: "https://arxiv.org/abs/2508.16085" },
      { name: "Shazam", year: 2026, data: "Fuses 5 models (UNI 2, Virchow2, H-optimus-1, Prov-Gigapath, Phikon-v2)", idea: "Adaptive integration/distillation", github: "", hf: "", paper: "https://arxiv.org/abs/2503.00736" },
      { name: "ALICE", year: 2026, data: "24.9M tiles + 155K high-res images", idea: "Agglomerative distillation", github: "https://github.com/WonderLandxD/ALICE", hf: "", paper: "https://arxiv.org/pdf/2607.09526" },
      { name: "ASTRA", year: 2026, data: "10.3K WSIs (CHTN cohort)", idea: "MoE fusion/alignment", github: "", hf: "", paper: "https://arxiv.org/abs/2604.22846" }
    ]
  },
  {
  ...
  },
  {
    ...
    models: [
      ...
      { name: "Patho-Bench/MahmoodLab", year: 2025, data: "Slide", idea: "Open-source benchmarking toolkit with standardized datasets and reproducible evaluation pipelines", github: "https://github.com/mahmoodlab/Patho-Bench", hf: "", paper: "https://arxiv.org/pdf/2502.06750" },
      ...
      { name: "PathBench", year: 2025, data: "Slide & Patch", idea: "Leakage-free multi-center clinical benchmark spanning multiple tasks, with a live public leaderboard", github: "https://github.com/birkhoffkiki/PathBench", hf: "", website: "https://birkhoffkiki.github.io/PathBench/", paper: "https://arxiv.org/abs/2505.20202" },
      { name: "Stanford PathBench", year: 2026, data: "Slide & Patch", idea: "Comprehensive benchmark of 32 PFMs across 41 tasks with a public leaderboard", github: "", hf: "", paper: "https://www.nature.com/articles/s41467-026-76004-6" }
    ]
  }
];
