const modelData = [
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "date": "2023-06-08",
        "data": "29K+ WSIs",
        "idea": "Big Transfer (BiT) representations followed by SimCLR contrastive pretraining on 29,018 WSIs / 50M pathology images, showing that in-domain self-supervision transfers to diagnostic tasks far more data-efficiently than ImageNet initialisation; part of a broader study that also covers non-pathology medical imaging",
        "stains": "H&E",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "date": "2023-07-26",
        "data": "6,093 WSIs",
        "idea": "iBOT masked-image pretraining on the 6,093-slide TCGA PanCancer corpus (>40M tiles), released as an open histology encoder together with a scaling study of self-supervised objectives for pathology",
        "stains": "H&E",
      ...
      },
      {
        ...
        "date": "2024-10-01",
        "data": "11K WSIs",
        "idea": "Self-supervised pretraining on paired H&E–IHC data with cross-scale and cross-stain pretext tasks over a MoCo v3 backbone, so a single encoder transfers across magnifications and across stains rather than being tied to one",
      ...
      },
      {
        ...
        "idea": "Curation rather than scale alone: DINOv2 with pathologist-guided tissue-cluster and slide-group sampling over 103,849 WSIs from >15 European and US laboratories, spanning 58 tissue types and 129 histochemical/IHC stain modalities",
      ...
      },
      {
        ...
        "date": "2024-05-13",
        "data": "195M tiles",
        "idea": "Pathology-Universal Transformer: a compact FlexiViT-S trained with a modified multi-task DINOv2 on 158,852 WSIs / 195M tiles from 50+ sites, yielding multi-scale representations usable from patch to slide level at low inference cost",
        "stains": "H&E + IHC",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "date": "2024-06-07",
        "data": "1M WSIs",
        "idea": "Open-source DINOv2 ViT family (Hibou-B and Hibou-L) trained on >1M proprietary WSIs and released openly, giving the field encoders at competitive scale without a proprietary licence",
        "stains": "H&E + IHC",
      ...
      },
      {
        ...
        "date": "2025-03-10",
        "data": "11M tiles",
        "idea": "BEiT-style masked-image pretraining on ~11M TCGA tiles (224x224 at 40x) across 32 cancer types, transferred to both cancer diagnosis and survival prediction",
        "stains": "H&E",
      ...
      },
      {
        ...
        "idea": "Scales the RudolfV recipe to 1.2M WSIs from 490K cases (Mayo + Charité) and 3.4B tiles spanning 70+ tissues, 100+ stains and 7 scanners, trading parameter count for data and scanner diversity",
      ...
      },
      {
        ...
        "audit_result": "Midnight-12k, trained on only ~12K public TCGA WSIs, outperforms most existing FMs and on average matches Virchow2; the central claim is comparable or better results with up to two orders of magnitude fewer WSIs"
      },
      {
        "name": "OpenMidnight",
        "year": 2025,
      ...
      },
      {
        ...
        "github": "",
        "hf": "",
        "paper": "https://arxiv.org/abs/2601.05148",
      ...
      },
      {
        ...
        "year": 2026,
        "date": "2026-06-03",
        "data": "25.7K WSIs (LoRA continued pretraining)",
      ...
      },
      {
        ...
        "date": "2026-05-06",
        "data": "57,271 WSIs",
        "idea": "Breast-adaptive pathology foundation model: DINO self-distillation continued on 57,271 breast WSIs (101,638 across the whole study) to specialise a general encoder for breast pathology, evaluated on 34 tasks over 82 cohorts",
        "stains": "H&E",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "year": 2026,
        "date": "2026-09-08",
        "data": "~11M patches from 9,457 bone marrow WSIs",
        "idea": "Bone-marrow-specific 1.1B ViT-G/14 pretrained with DINOv2 on about 11M multi-magnification (5x to 40x) patches from only 9,457 WSIs. The paper finds that long SSL training keeps improving global semantics while dense, morphology-sensitive features degrade, so it adds late-stage Gram Anchoring and introduces iGram, whose frozen anchor sees 512x512 upsampled inputs and so tokenizes small cells more densely. It beats UNI2 and Virchow2 on bone marrow tasks despite using roughly 35x and 310x fewer WSIs",
        "stains": "H&E",
        "github": "",
        "hf": "",
        ...
        "paper_author": "Sapkota",
        "audit_objective": "DINOv2 (DINO + iBOT + KoLeo) for 450K iterations, then 50K iterations of late-stage regularization with either Gram Anchoring or iGram (interpolated Gram Anchoring, with anchor features computed on 512x512 upsampled inputs)",
        "audit_wsis": "9,457 bone marrow core-biopsy H&E WSIs, one per case, collected 2022-2025 from Mayo Clinic-affiliated sources; about 35x fewer than UNI2 and 310x fewer than Virchow2",
        "audit_patches": "~11M 256x256 patches from U-Net tissue detection and content-aware sampling, at 5x, 10x, 20x and 40x",
        "audit_organs": "Bone marrow (core biopsies)",
        "audit_downstream": "Global: disease classification, megakaryocyte morphology, fibrosis grading, cellularity and myeloid-to-erythroid ratio. Dense: multiclass cell detection (Faster R-CNN) and binary cell instance segmentation (Mask R-CNN) on frozen encoders",
        "audit_benchmark": "Five global case-level tasks and two dense tasks, comparing BM1b, BM1b + Gram and BM1b + iGram against UNI2 and Virchow2",
        "audit_result": "Average global AUC 84.59 for BM1b versus 82.09 for UNI2 and 81.81 for Virchow2, rising to 85.12 with Gram Anchoring (84.69 with iGram); overall dense score 78.08, then 78.54 with Gram and 78.90 with iGram, which also gives the best macro, cell, megakaryocyte-nuclei and instance-segmentation mIoU",
        "audit_scanners": "Leica GT 450 and Pramana SpectralHT",
        "audit_cohorts": "Mayo Clinic-affiliated sources, without a per-institution breakdown; the authors note that external validation at independent institutions is still needed"
      }
    ]
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "idea": "Whole-slide model over a private real-world clinical corpus: a DINOv2 tile encoder feeding a LongNet masked-autoencoder slide encoder, whose dilated attention makes the full gigapixel context tractable",
        "stains": "H&E + IHC",
      ...
      },
      {
        ...
        "idea": "Weakly supervised slide-level pattern recognition: CLIP text-guided aggregation over CTransPath tile features across a 44-TB, 60,530-WSI pretraining corpus, giving one slide model for cancer detection, tumour-origin identification, molecular-profile prediction and prognosis, externally validated on 19,491 WSIs",
        "stains": "H&E",
      ...
      },
      {
        ...
        "date": "2025-06-10",
        "data": "3,944 WSIs (BWH)",
        "idea": "Transferable pretrained MIL aggregators rather than another tile encoder: aggregators supervised on PC-43 (43 cancer types) and PC-108 (108 OncoTree codes) over 3,944 BWH slides transfer to new slide-level tasks with far less task data",
        "stains": "H&E",
      ...
      },
      {
        ...
        "date": "2025-07-09",
        "data": "37K WSIs",
        "idea": "End-to-end hierarchical training with direct slide-level supervision on 37,195 FFPE H&E WSIs across 33 cancer types and 12 organ systems, so tile and slide representations are learned jointly instead of in separate frozen stages",
        "stains": "H&E (FFPE)",
        "github": "",
        "hf": "",
        "paper": "https://arxiv.org/abs/2507.06639",
      ...
      },
      {
        ...
        "date": "2026-03-27",
        "data": "77K WSIs",
        "idea": "Patient-first aggregation: a masked self-distillation slide encoder feeds a case-level transformer that models relationships between a patient's multiple slides, trained entirely on public data",
        "stains": "H&E",
  ...
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "idea": "CoCa-style task-agnostic vision–language pretraining for pathology: iBOT vision pretraining plus contrastive-and-captioning training on 1.17M image–text pairs, giving zero-shot classification, retrieval and captioning from one model",
      ...
      },
      {
        ...
        "idea": "Generative slide-level model over frozen Virchow tile embeddings: a Perceiver aggregator trained with CoCa (contrastive + captioning) against 195K clinical reports, so it can both score and describe a slide; the reports are not one-to-one WSI–report pairs",
        "stains": "H&E",
        "github": "",
      ...
      },
      {
        ...
        "idea": "15B-parameter unified patch-and-slide multimodal model (Qwen2.5-14B backbone) built on CPath-CLIP (an LLM text encoder paired with Virchow2) plus instruction tuning over 700,145 image–caption pairs, so patch and WSI tasks are handled by a single model",
      ...
      },
      {
        ...
        "idea": "Injects a disease knowledge graph (11,454 diseases, 139,143 attributes) into vision–language contrastive training over 143K knowledge-grouped image–text pairs, so semantically related diagnoses are grouped rather than treated as unrelated captions",
      ...
      },
      {
        ...
        "date": "2025-06-16",
        "data": "2.3M WSIs",
        "idea": "Extends PRISM with clinical-dialogue supervision: CoCa contrastive-plus-autoregressive pretraining over ~2.3M Paige/MSK WSIs with paired diagnostic reports, then conversational tuning, so the model answers diagnostic, biomarker and report-QA queries rather than only scoring slides",
        "stains": "H&E",
        "github": "",
  ...
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "paper": "https://arxiv.org/abs/2408.02859",
      ...
      },
      {
        ...
        "idea": "Multimodal knowledge-enhanced whole-slide model that contrastively aligns H&E slides with their pathology reports and RNA-seq, using 26,169 slide-level pairs across 10,275 patients so slide representations carry report and molecular context",
        "stains": "H&E",
      ...
      },
      {
        ...
        "date": "2026-02-25",
        "data": "34K WSIs",
        "idea": "Molecular-guided adaptive region modeling: rather than tiling a slide uniformly, region selection is guided by paired molecular signal (13,289 WSI–RNA and 8,225 WSI–protein pairs over 34,277 pretraining WSIs; TCGA 11,463 + GTEx 22,814), so the encoder attends to the regions that actually carry molecular information",
        "stains": "H&E",
  ...
  {
    "category": "Task & Domain Adaptation",
    "models": [
      {
        "name": "SEAL",
        "year": 2026,
        "date": "2026-02-15",
        "data": ">700K paired ST spot–region examples (14 organs)",
        "idea": "Adapts existing pathology FMs with spatial transcriptomics instead of pretraining a new encoder: parameter-efficient vision–omics fine-tuning guided by >700K paired gene-expression spot–tissue-region examples across 14 organs, evaluated on 53 tasks (38 slide-level, 15 patch-level) covering molecular status, pathways, treatment response, gene-expression prediction and gene→image retrieval",
        "stains": "H&E (+ spatial transcriptomics)",
      ...
      },
      {
        ...
        "year": 2026,
        "date": "2026-07-24",
        "data": "Fine-tuned from Phikon-v2 (no new corpus)",
        "idea": "Robustness fine-tuning of Phikon-v2 rather than fresh pretraining: post-hoc tuning that cuts medical-center and scanner confounding while holding downstream accuracy, evaluated on PathoROB, HEST, THUNDER and a Patho-Bench subset",
        "stains": "H&E",
        "github": "",
      ...
      },
      {
        ...
        "year": 2026,
        "date": "2026-07-24",
        "data": "Fine-tuned from Midnight-12k (no new corpus)",
        "idea": "The same robustness fine-tuning recipe applied to Midnight-12k: a post-hoc tuned encoder that reduces center and scanner confounding without retraining from scratch, evaluated on the same suites as Phaet",
        "stains": "H&E",
        "github": "",
  ...
  {
    "category": "Compression & Distillation",
    "models": [
      {
        "name": "H0-mini",
      ...
      },
      {
        ...
        "idea": "Expert-and-self knowledge distillation that folds multiple teacher encoders into one generalizable model, trained on ~86K public H&E WSIs / 190M tiles spanning 34 tissue types",
        "stains": "H&E",
      ...
      },
      {
        ...
        "idea": "Agglomerative distillation from eight heterogeneous teachers (UNI-2, Virchow-2, H-Optimus-1 for vision; CONCH, MUSK, KEEP for vision–language; TITAN, CARE for slide level) into a single student that inherits supervision at all three levels",
        "stains": "H&E",
        "github": "",
        "hf": "",
        "paper": "https://arxiv.org/abs/2607.09526",
        ...
        "audit_notes": "The paper states the model is available at github.com/WonderLandxD/ALICE, but that repository is not public as of September 2026, and no weights were found under the authors' Hugging Face accounts.",
  ...
  {
    "category": "Multi-FM Fusion & Ensembling",
    "models": [
      {
        "name": "COBRA",
        "year": 2025,
        "date": "2024-11-20",
        "data": "3048 WSIs",
        "idea": "Integrates four tile encoders (CTransPath, UNI, Virchow2, H-optimus-0) into one slide representation via contrastive pretraining on 3,048 TCGA WSIs from 2,848 patients, so the slide model is not tied to any single encoder",
        "stains": "H&E",
      ...
      },
      {
        ...
        "idea": "Ensembles five FMs (GigaPath, CONCH v1.5, Virchow2, H-optimus-0, UNI) into a single slide-level representation, pretrained on 53,699 WSIs across 20 anatomical sites and 11 public datasets",
        "stains": "H&E",
        ...
        "audit_notes": "",
        "paper_title": "Ensemble learning of pathology foundation models for precision oncology",
        "paper_author": "Luo"
      },
      {
        "name": "Meta-Encoder",
      ...
      },
      {
        ...
        "idea": "Adaptive online expert weighting that distills five FMs (UNI 2, Virchow2, H-optimus-1, Prov-GigaPath, Phikon-v2) at inference time rather than into a fixed offline student, so the mixture adapts per input",
  ...
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "date": "2026-04-04",
        "data": "100M patches",
        "idea": "Multimodal pathology diffusion transformer for conditional histology synthesis, with the generated images additionally assessed as augmentation data for downstream training",
        "stains": "H&E",
        "github": "",
        "hf": "https://huggingface.co/collections/xiangjx/mupad-696334b4a732662b4d3f9b35",
        ...
        "audit_notes": "Weights are released on Hugging Face as MuPaD-256, MuPaD-512 and MuPaD-HE2mIF (the authors spell the release MuPaD; the paper writes MuPD). No code repository has been published: the paper cites none, and neither lilab-stanford nor the first author's account hosts one.",
  ...
  {
    "category": "General Benchmarking & Leaderboards",
    "models": [
      {
        "name": "EVA",
        "year": 2024,
      ...
      },
      {
        ...
        "year": 2024,
        "date": "2024-06-23",
        "data": "Patch (spatial): expression prediction",
        "idea": "Pairs 1,229 spatial-transcriptomic profiles with their H&E whole-slide images and extensive metadata, assembled from 153 public and internal cohorts spanning 26 organs, two species and 367 cancer samples from 25 cancer types; the derived HEST-Benchmark turns 2.1M expression–morphology pairs into a standard test of whether a tile encoder's features actually predict gene expression, and is now among the most widely reported PFM benchmarks",
        "github": "https://github.com/mahmoodlab/HEST",
        "hf": "",
        "paper": "https://arxiv.org/abs/2406.16192",
        "bibtex": "@misc{jaume2024hest1kdatasetspatialtranscriptomics,\n      title={HEST-1k: A Dataset for Spatial Transcriptomics and Histology Image Analysis}, \n      author={Guillaume Jaume and Paul Doucet and Andrew H. Song and Ming Y. Lu and Cristina Almagro-Pérez and Sophia J. Wagner and Anurag J. Vaidya and Richard J. Chen and Drew F. K. Williamson and Ahrong Kim and Faisal Mahmood},\n      year={2024},\n      eprint={2406.16192},\n      archivePrefix={arXiv},\n      primaryClass={cs.CV},\n      url={https://arxiv.org/abs/2406.16192}, \n}",
        "audit_objective": "Benchmarking pathology FMs on gene-expression prediction from morphology, alongside biomarker exploration and multimodal representation learning",
        "audit_wsis": "1,229 spatial-transcriptomic profiles, each linked to a WSI",
        "audit_domain": "Histology-to-spatial-transcriptomics evaluation of tile encoders (HEST-Benchmark), released with the HEST-1k dataset and HEST-Library",
        "audit_benchmark": "2.1 million expression–morphology pairs and over 76 million nuclei derived from 153 cohorts; three use cases: FM benchmarking, biomarker exploration and multimodal representation learning",
        "audit_result": "Benchmark tasks show a logarithmic scaling law for gene-expression prediction, and fine-tuning large models improves multimodal representation learning",
        "audit_organs": "26 organs; 367 cancer samples across 25 cancer types",
        "audit_downstream": "Gene-expression prediction from H&E tiles; biomarker exploration; multimodal representation learning",
        "audit_cohorts": "153 public and internal cohorts; two species (Homo sapiens, Mus musculus)",
        "audit_omics": "Spatial transcriptomics",
      ...
      },
      {
        ...
        "date": "2025-07-10",
        "data": "Patch",
        "idea": "Tile-level benchmark that compares 23 foundation models across 16 datasets and deliberately goes past downstream accuracy: it inspects each model's feature space and quantifies the robustness and predictive uncertainty implied by its embeddings, on the argument that in healthcare a leaderboard number alone is not enough to judge reliability; built as a fast, dynamic harness that also accepts user-defined local models for direct comparison",
        "github": "https://github.com/MICS-Lab/thunder",
        "hf": "",
        "paper": "https://arxiv.org/abs/2507.07860",
        "bibtex": "@misc{marza2026thundertilelevelhistopathologyimage,\n      title={THUNDER: Tile-level Histopathology image UNDERstanding benchmark}, \n      author={Pierre Marza and Leo Fillioux and Sofiène Boutaj and Kunal Mahatha and Christian Desrosiers and Pablo Piantanida and Jose Dolz and Stergios Christodoulidis and Maria Vakalopoulou},\n      year={2026},\n      eprint={2507.07860},\n      archivePrefix={arXiv},\n      primaryClass={cs.CV},\n      url={https://arxiv.org/abs/2507.07860}, \n}",
        "audit_objective": "Tile-level FM comparison spanning downstream performance, feature-space analysis, robustness and uncertainty",
        "audit_domain": "Tile-level histopathology image understanding across diverse tasks",
        "audit_benchmark": "23 foundation models evaluated on 16 datasets, with downstream tasks plus feature-space, robustness and uncertainty analyses",
        "audit_result": "Provides a comprehensive comparison of the 23 models, adding the feature-space, robustness and uncertainty dimensions that accuracy-only leaderboards omit, and stays extensible to newly released or local user-defined models",
        "audit_downstream": "Tile- and slide-level downstream tasks, uncertainty estimation and robustness evaluation",
        "audit_notes": "Cited as an evaluation suite by four other entries in this catalog.",
        "paper_title": "THUNDER: Tile-level Histopathology image UNDERstanding benchmark",
        "paper_author": "Marza"
      }
    ]
  },
  {
    "category": "Organ- & Task-Specific Benchmarking",
    "models": [
      {
      ...
      {
        "name": "Endometrial FM Benchmark",
        "year": 2026,
        "date": "2026-08-19",
        "data": "Slide (endometrial)",
        "idea": "Evaluates seven pathology FMs (H-optimus-0, CONCH and Virchow2 among them) as feature extractors for endometrial cancer across morphological classification, molecular prediction and prognosis, on 3,293 patients pooled from clinical studies and randomised trials; the best general-purpose models beat EsVIT, an endometrial-specific extractor trained only on EC samples, yet the authors argue choosing a model for a new application stays hard because top models plateau and their training data is poorly documented",
        "github": "",
        "hf": "",
        "paper": "https://doi.org/10.1016/j.modpat.2026.101070",
        "bibtex": "@article{vandenBerg_2026, title={Assessing Foundation Models for Computational Pathology in Endometrial Cancer}, ISSN={0893-3952}, url={http://dx.doi.org/10.1016/j.modpat.2026.101070}, DOI={10.1016/j.modpat.2026.101070}, journal={Modern Pathology}, publisher={Elsevier BV}, author={van den Berg, Nikki J. and Volinsky-Fremond, Sarah and Barkey Wolf, Jurriaan and Schoenpflug, Lydia A. and Andani, Sonali and \\O{}rtoft, Gitte and Jobsen, Jan J. and Lutgens, Ludy C. H. W. and Powell, Melanie E. and Mileshkin, Linda R. and Mackay, Helen and Leary, Alexandra and Razack, Rubina R. and de Bruyn, Marco and de Boer, Stephanie M. and Nout, Remi A. and Smit, Vincent T. H. B. M. and Creutzberg, Carien L. and Koelzer, Viktor H. and Bosse, Tjalling and Horeweg, Nanda}, year={2026}, month=Aug, pages={101070} }",
        "audit_objective": "Comparative evaluation of frozen pathology FM features on a single subspecialty, against an organ-specific baseline extractor",
        "audit_domain": "Endometrial cancer: which foundation model to pick for morphological, molecular and prognostic tasks",
        "audit_benchmark": "Seven pathology foundation models (including H-optimus-0, CONCH and Virchow2) plus the endometrial-specific EsVIT baseline, on 3,293 endometrial cancer patients from clinical studies and randomised trials",
        "audit_result": "The best general-purpose FMs outperform EsVIT despite it being trained exclusively on endometrial cancer samples; the authors conclude that model selection for a new application remains difficult because the leading models plateau against each other and their training-data provenance is insufficiently documented",
        "audit_organs": "Uterus / endometrium",
        "audit_downstream": "Morphological classification; molecular subtype prediction; prognostic assessment",
        "audit_cohorts": "3,293 patients pooled from clinical studies and randomised trials",
        "audit_notes": "",
        "paper_title": "Assessing Foundation Models for Computational Pathology in Endometrial Cancer",
        "paper_author": "van den Berg"
      }
    ]
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "date": "2024-07-15",
        "data": "",
        "idea": "Trains a sparse autoencoder on a pathology FM's embeddings to pull monosemantic biological concepts out of polysemantic activations: individual SAE dimensions correlate strongly with cell-type counts such as plasma cells and lymphocytes, those features are absent from a natural-image SSL model, they sharpen with depth as the encoder becomes robust to non-biological factors like scanner type, and they generalize to an out-of-domain dataset",
        "github": "",
        "hf": "",
        ...
        "paper_title": "Learning biologically relevant features in a pathology foundation model using sparse autoencoders",
        "paper_author": "Le",
  ...
  },
  {
    ...
    "models": [
      ...
      },
      {
        ...
        "date": "2025-04-05",
        "data": "",
        "idea": "Organizes pathology foundation models with a hierarchical, top-down taxonomy (model scope, model pretraining, model design) that is meant to generalize to foundation-model analysis in any domain, and separately categorizes PFM evaluation into slide-level, patch-level, multimodal and biological tasks to give comprehensive benchmarking criteria; frames the open problems as development-side (pathology-specific methodology, end-to-end pretraining, data-model scalability) versus utilization-side (effective adaptation, model maintenance)",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "date": "2024-08-23",
        "data": "",
        "idea": "Systematic overview of how foundation models and vision-language models are reshaping the computational-pathology workflow: FMs learn a representation space adaptable to many downstream tasks without explicit supervision, while VLMs turn free-text pathology reports into a rich semantic training signal and allow predictions to be returned in natural language; catalogues and groups the models alongside the tools, datasets and training schemes behind them",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "date": "2025-02-24",
        "data": "",
        "idea": "First quantitative, systematic evaluation of ethical risk in PFMs, covering three interrelated failure modes: how far patient-sensitive attributes can be inferred from the learned representations (privacy leakage), how much accuracy varies across demographic and institutional subgroups (group fairness), and how much diagnosis-irrelevant features drive predictions (clinical reliability); investigates the underlying causes, validates them empirically, and proposes mitigations plus an assessment framework to be released as an online auditing toolkit",
        "github": "",
        "hf": "",
        ...
        "paper_title": "Beyond Diagnostic Performance: Revealing and Quantifying Ethical Risks in Pathology Foundation Models",
        "paper_author": "Lin",
        "tag": "perspective",
        "tag_color": "purple"
      },
      {
        ...
        "date": "2025-02-12",
        "data": "",
        "idea": "Reviews the field's arc from vision-only self-supervision to contrastive vision-language frameworks and generative 'co-pilots' that mine sub-visual tissue cues, write reports and answer complex queries, set against data growth from tens to millions of multi-gigapixel slides and models reaching billions of parameters; interrogates the definition itself (what makes a model foundational, general or multipurpose), and argues that global benchmarks are the missing prerequisite for evaluation standards, clinical adoption and the public trust and regulatory support that adoption depends on",
        "github": "",
        "hf": "",
      ...
      },
      {
        ...
        "date": "2026-06-12",
        "data": "",
        "idea": "Argues the failures of foundation models in pathology (low accuracy, instability, heavy compute) are conceptual rather than tuning problems: dense embeddings cannot represent the combinatorial richness of tissue, and current architectures inherit flaws in self-supervision, patch design and noise-fragile pretraining from natural-image methods whose assumptions do not hold for tissue; concludes that pathology needs architectures purpose-built for biological images rather than adaptations of large-scale vision models",
        "github": "",
        "hf": "",
